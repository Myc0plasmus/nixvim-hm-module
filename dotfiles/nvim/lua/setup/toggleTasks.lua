...
vim.keymap.set('n', '<space>rt', require('telescope').extensions.toggletasks.spawn,
    { desc = 'toggletasks: spawn' })
vim.keymap.set('n', '<space>te', require('telescope').extensions.toggletasks.edit,
    { desc = 'toggletasks: edit' })
vim.keymap.set('n', '<space>ts', require('telescope').extensions.toggletasks.select,
